	      ...
	      <div class="container ">
	        ...
	        <div class="collapse navbar-collapse" id="navbarResponsive">
	          <ul class="navbar-nav ml-auto">
	            ...
	            <li class="nav-item">
	              <button class="btn btn-outline-info"> <a class="nav-link js-scroll-trigger" href="#contact">hacer denuncia</a></button>
	            </li>
	          </ul>
	        </div>
	      </div>
	...
	<br>
	      <div class="container-fluid p-0">
	        <div class="row no-gutters">
	          ...
	          <div class="col-lg-4 col-sm-6">
	            <a class="portfolio-box" href="img/perro2.gif">
	              <img class="img-fluid" src="img/perro2.gif" alt="">
	              <div class="portfolio-box-caption">
	                <div class="portfolio-box-caption-content">
	                  <div class="project-category text-faded">
	                    Category
	          ...
	          <div class="col-lg-4 col-sm-6">
	            <a class="portfolio-box" href="img/gato3.gif">
	              <img class="img-fluid" src="img/gato3.gif" alt="">
	              <div class="portfolio-box-caption">
	                <div class="portfolio-box-caption-content">
	                  <div class="project-category text-faded">
	                    nombre
	          ...
	          <div class="col-lg-4 col-sm-6">
	            <a class="portfolio-box" href="img/perro3.gif">
	              <img class="img-fluid" src="img/perro3.gif" alt="">
	              <div class="portfolio-box-caption">
	                <div class="portfolio-box-caption-content">
	                  <div class="project-category text-faded">
	                    nombre
	      ...
	      <section class="bg-gradient-primary text-dark">
	      <div class="container text-center">
	        <h2 class="mb-4">conocer todas nuestras mascotas</h2>
	        <a class="btn btn-light btn-xl sr-button" href="galeria1.html" >Registrar o ingresar</a>
	      </div>
	        ...
	        <div class="row">
	          <div class="col-lg-3 col-md-6 text-center">
	            <div class="service-box mt-5 mx-auto">
	              ...
	              <h3 class="mb-3"> <a href="#"> en domicilio de hogares </a></h3>
	          ...
	          <div class="col-lg-3 col-md-6 text-center">
	            <div class="service-box mt-5 mx-auto">
	              ...
	              <h3 class="mb-3"> <a href="#">en linea </a></h3>
	          ...
	          <div class="col-lg-3 col-md-6 text-center">
	            <div class="service-box mt-5 mx-auto">
	              ...
	              <h3 class="mb-3"><a href="#" >puntos de atencion </a></h3>
	          ...
	          <div class="col-lg-3 col-md-6 text-center">
	            <div class="service-box mt-5 mx-auto">
	              ...
	              <h3 class="mb-3"><a href="#">contactanos</a></h3>
	    ...
	    <section class="p-0" id="portfolio">
	      ...
	      <div class="container text-center">
	        <h2 class="mb-4">conocer todas nuestras mascotas</h2>
	        <a class="btn btn-light btn-xl sr-button" href="galeria1.html" >mi futura mascota</a>
	      </div>
	    ...
	    <section id="contact">
	      <div class="container">
	        <div class="row">
	          <div class="col-lg-8 mx-auto text-center">
	            <h2 class="section-heading">casos de adopcion, denuncias y otros</h2>
	            <hr class="my-4">
	    ...
	    <button type="submit" class="btn btn-login float-right">Submit</button>
	                        ...
	                        <div class="modal-footer">
	                            <div class="options text-center text-md-right mt-1">
	                                ...
	                                <p>¿Se te olvidó tu contraseña? <a href="#" class="blue-text">recuperala</a></p>
	                            </div>
